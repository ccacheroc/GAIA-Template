...
- Update @/specs/ModeloDatos.md and @/.agent/rules/Arquitectura.md to reflect any data-model or architectural changes introduced.
...
- Update the relevant **Feature Specification** or Project Documentation in `specs/`. 
  - **DO NOT** update `@/.agent/rules/Arquitectura.md` or `@/specs/ModeloDatos.md` with application-specific details (e.g., specific entities or modules). These files must remain generic.
